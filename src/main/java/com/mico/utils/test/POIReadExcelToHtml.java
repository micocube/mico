...
public class POIReadExcelToHtml {
    ...
    public void test() throws Exception{
        ...
        String path = "F:\\doc\\";//E://Microsoft Excel 工作表.xlsx
        String file = "ex.xls";
        InputStream is = null;
        ...
        try {
            ...
            org.apache.commons.io.FileUtils.writeStringToFile(new File(path, "ex.html"), htmlExcel, "utf-8");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
    ...
    public static String getExcelInfo(Workbook wb, boolean isWithStyle) {
        ...
        for (int ix = 0, max = wb.getNumberOfSheets(); ix < max; ix++) {
            Sheet sheet = wb.getSheetAt(ix);//获取第一个Sheet的内容
